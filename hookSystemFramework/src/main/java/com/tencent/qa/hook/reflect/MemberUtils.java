...
public class MemberUtils {
    ...
    static boolean setAccessibleWorkaround(final AccessibleObject o) {
        ...
        Log.d("MemberUtils", "setAccessibleWorkaround isAccessible is " + o.isAccessible());
        Log.d("MemberUtils", "setAccessibleWorkaround isPublic is " + Modifier.isPublic(m.getModifiers()));
        Log.d("MemberUtils", "setAccessibleWorkaround isPackageAccess is " + isPackageAccess(m.getDeclaringClass().getModifiers()));
