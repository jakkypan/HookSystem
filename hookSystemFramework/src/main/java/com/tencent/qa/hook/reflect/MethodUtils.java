...
public class MethodUtils {
    ...
    public static Method getAccessibleMethod(final Class<?> cls, final String methodName,
        ...
        Method accessibleMethod = getAccessibleMethod(cls.getDeclaredMethod(methodName, parameterTypes));
        synchronized (sMethodCache) {
    ...
    private static Method getMatchingAccessibleMethod(final Class<?> cls,
        ...
        if (bestMatch == null) {
            bestMatch = getAccessibleMethodFromSuperclass(cls, methodName, parameterTypes);
        }
    ...
    public static Object invokeStaticMethod(final Class clazz, final String methodName,
        ...
        Log.d("MethodUtils", "invokeStaticMethod isAccessible is " + method.isAccessible());
